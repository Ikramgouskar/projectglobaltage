...
export default function Acidesamine() {
  ...
  useEffect(() => {
    try {
      const oligoCategory = productsData.products.find((product) => product.category === "ACIDES AMINES")
      setAcides(oligoCategory?.products || [])
      setLoading(false)
    } catch (error) {
