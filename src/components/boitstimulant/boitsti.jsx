...
export default function Boitsti() {
  ...
  useEffect(() => {
    try {
      const filettherCategory = productsData.products.find((product) => product.category === "BIOSTIMULANT")
      setBoitsti(filettherCategory?.products || [])
      setLoading(false)
    } catch (error) {
