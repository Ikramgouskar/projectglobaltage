...
export default function Filettisseombrage({product}) {
  ...
  useEffect(() => {
    const fetchCorgettes = async () => {
      try {
        const response = await axios.get("http://localhost:8003/products?category=TOURBES REMPOTAGE")
  ...
  return (
    ...
    <div className="engrais-container">
      <div className="engrais-header">
        <h2 className="engrais-title">TOURBES REMPOTAGE</h2>
        {stateuser ? (
      <button
        style={{
          width: "350px",
