...
export default function Tourbemelange({product}) {
  ...
  useEffect(() => {
    const fetchCorgettes = async () => {
      try {
        const response = await axios.get("http://localhost:8003/products?category=SUBSTRATS MELANGE")
  ...
  return (
    ...
    <div className="engrais-container">
      <div className="engrais-header">
        <h2 className="engrais-title">SUBSTRATS MELANGE</h2>
        {stateuser ? (
      <button
        style={{
          width: "350px",
