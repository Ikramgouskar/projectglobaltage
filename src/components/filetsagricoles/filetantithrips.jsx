...
export default function Filetantithrips() {
  ...
  useEffect(() => {
    try {
      const filettherCategory = productsData.products.find((product) => product.category === "FILETANTITHRIPS")
      setFiletther(filettherCategory?.products || [])
      setLoading(false)
    } catch (error) {
