...
export default function Filettisseombrage() {
  ...
  useEffect(() => {
    try {
      const filetombrCategory = productsData.products.find((product) => product.category === "FILET TISSE OMBRAGE")
      setFfiletombr(filetombrCategory?.products || [])
      setLoading(false)
    } catch (error) {
  ...
  return (
    <div className="engrais-container">
      <div className="engrais-header">
        <h2 className="engrais-title">FILET TISSE OMBRAGE</h2>
